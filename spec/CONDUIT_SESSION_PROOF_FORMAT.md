...
```
conduit_proof_{session_prefix}_{unix_timestamp}.tar.gz
└── session_proof/
...
```
conduit_proof_{session_id[0:8]}_{int(unix_timestamp)}.tar.gz
```
...
{
  "session_id":       "sess-abc123",
  "exported_at":      "2026-03-12T15:30:45Z",
  "action_count":     42,
  "chain_hash":       "a1b2c3d4...",
...
| `conduit_version` | String | No | Version of the producing software. |
...
The reference implementation is located at `tools/conduit_proof.py` in the Conduit repository. Key entry point:
