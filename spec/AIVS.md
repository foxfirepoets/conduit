# AI Visibility Verification Standard (AIVS) v1.0
...
### v1.0 (2026-03-14)
- Renamed from CSPF (Conduit Session Proof Format) to AIVS (AI Visibility Verification Standard).
